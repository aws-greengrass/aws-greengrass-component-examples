...
def set_configuration(config):
    ...
    if "ImageDirectory" in config:
        ...
        config_utils.logger.info("Using default image directory: {}".format(config_utils.IMAGE_DIR))
    ...
    if "PublishResultsOnTopic" in config:
        ...
        config_utils.TOPIC = ""
        config_utils.logger.info("Topic to publish inference results is empty.")
