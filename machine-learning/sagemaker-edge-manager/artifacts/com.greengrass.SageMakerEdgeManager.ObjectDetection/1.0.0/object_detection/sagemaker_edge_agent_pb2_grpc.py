...
import sagemaker_edge_agent_pb2 as sagemaker__edge__agent__pb2
...
class AgentStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                ...
                request_serializer=sagemaker__edge__agent__pb2.PredictRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.PredictResponse.FromString,
                )
        self.LoadModel = channel.unary_unary(
                '/AWS.SageMaker.Edge.Agent/LoadModel',
                request_serializer=sagemaker__edge__agent__pb2.LoadModelRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.LoadModelResponse.FromString,
                )
        self.UnLoadModel = channel.unary_unary(
                '/AWS.SageMaker.Edge.Agent/UnLoadModel',
                request_serializer=sagemaker__edge__agent__pb2.UnLoadModelRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.UnLoadModelResponse.FromString,
                )
        self.ListModels = channel.unary_unary(
                '/AWS.SageMaker.Edge.Agent/ListModels',
                request_serializer=sagemaker__edge__agent__pb2.ListModelsRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.ListModelsResponse.FromString,
                )
        self.DescribeModel = channel.unary_unary(
                '/AWS.SageMaker.Edge.Agent/DescribeModel',
                request_serializer=sagemaker__edge__agent__pb2.DescribeModelRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.DescribeModelResponse.FromString,
                )
        self.CaptureData = channel.unary_unary(
                '/AWS.SageMaker.Edge.Agent/CaptureData',
                request_serializer=sagemaker__edge__agent__pb2.CaptureDataRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.CaptureDataResponse.FromString,
                )
        self.GetCaptureDataStatus = channel.unary_unary(
                '/AWS.SageMaker.Edge.Agent/GetCaptureDataStatus',
                request_serializer=sagemaker__edge__agent__pb2.GetCaptureDataStatusRequest.SerializeToString,
                response_deserializer=sagemaker__edge__agent__pb2.GetCaptureDataStatusResponse.FromString,
                )
...
class AgentServicer(object):
    ...
    def LoadModel(self, request, context):
        ...
        5. ALREADY_EXISTS - model with the same handle is already loaded
...
def add_AgentServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Predict': grpc.unary_unary_rpc_method_handler(
                    servicer.Predict,
                    request_deserializer=sagemaker__edge__agent__pb2.PredictRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.PredictResponse.SerializeToString,
            ),
            'LoadModel': grpc.unary_unary_rpc_method_handler(
                    servicer.LoadModel,
                    request_deserializer=sagemaker__edge__agent__pb2.LoadModelRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.LoadModelResponse.SerializeToString,
            ),
            'UnLoadModel': grpc.unary_unary_rpc_method_handler(
                    servicer.UnLoadModel,
                    request_deserializer=sagemaker__edge__agent__pb2.UnLoadModelRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.UnLoadModelResponse.SerializeToString,
            ),
            'ListModels': grpc.unary_unary_rpc_method_handler(
                    servicer.ListModels,
                    request_deserializer=sagemaker__edge__agent__pb2.ListModelsRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.ListModelsResponse.SerializeToString,
            ),
            'DescribeModel': grpc.unary_unary_rpc_method_handler(
                    servicer.DescribeModel,
                    request_deserializer=sagemaker__edge__agent__pb2.DescribeModelRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.DescribeModelResponse.SerializeToString,
            ),
            'CaptureData': grpc.unary_unary_rpc_method_handler(
                    servicer.CaptureData,
                    request_deserializer=sagemaker__edge__agent__pb2.CaptureDataRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.CaptureDataResponse.SerializeToString,
            ),
            'GetCaptureDataStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCaptureDataStatus,
                    request_deserializer=sagemaker__edge__agent__pb2.GetCaptureDataStatusRequest.FromString,
                    response_serializer=sagemaker__edge__agent__pb2.GetCaptureDataStatusResponse.SerializeToString,
            ),
    }
...
class Agent(object):
    ...
    def Predict(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/Predict',
            sagemaker__edge__agent__pb2.PredictRequest.SerializeToString,
            sagemaker__edge__agent__pb2.PredictResponse.FromString,
    ...
    def LoadModel(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/LoadModel',
            sagemaker__edge__agent__pb2.LoadModelRequest.SerializeToString,
            sagemaker__edge__agent__pb2.LoadModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UnLoadModel(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/UnLoadModel',
            sagemaker__edge__agent__pb2.UnLoadModelRequest.SerializeToString,
            sagemaker__edge__agent__pb2.UnLoadModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListModels(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/ListModels',
            sagemaker__edge__agent__pb2.ListModelsRequest.SerializeToString,
            sagemaker__edge__agent__pb2.ListModelsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DescribeModel(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/DescribeModel',
            sagemaker__edge__agent__pb2.DescribeModelRequest.SerializeToString,
            sagemaker__edge__agent__pb2.DescribeModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CaptureData(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/CaptureData',
            sagemaker__edge__agent__pb2.CaptureDataRequest.SerializeToString,
            sagemaker__edge__agent__pb2.CaptureDataResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetCaptureDataStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AWS.SageMaker.Edge.Agent/GetCaptureDataStatus',
            sagemaker__edge__agent__pb2.GetCaptureDataStatusRequest.SerializeToString,
            sagemaker__edge__agent__pb2.GetCaptureDataStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
